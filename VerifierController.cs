            ...
            try
            {
                ...
                if (presentationResponse["requestStatus"].ToString() == "presentation_verified")
                {
                    var cacheData = new
                    {
                        ...
                        fullname = presentationResponse["verifiedCredentialsData"][0]["claims"]["fullname"].ToString(),
                        company = presentationResponse["verifiedCredentialsData"][0]["claims"]["company"].ToString(),
