#pragma checksum "/home/azureusercoffeeuniversity/GartnerHotel/verifiedidsample/Pages/Verifier.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4727c1766945a95510ccbe55ac384c6acf916e80"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4727c1766945a95510ccbe55ac384c6acf916e80", @"/Pages/Verifier.cshtml")]
...
#nullable disable
		...
		<object type = ""image/svg+xml"" id = ""sign-in"" data = ""loading-icon.svg""> </object>
            ...
            <div id=""");
            WriteLiteral(@"pinCodeText"" style=""display: none""></div>
  ...
  ");
            WriteLiteral(@"                  fetch('/api/verifier/presentation-request')
                    .then(function(response) {
                        ...
                        .then(function(message) {
                            ...
                            if( /Android/i.test(navigator.userAgent) ) {
                                ...
                                window.location.re");
            WriteLiteral(@"place(respPresentationReq.url);
                            } else {
            ...
            WriteLiteral(@"onse.length > 0) {
					...
					document.getEleme");
            WriteLiteral(@"ntById('sign-in').style.display = ""none"";
					...
					document.getElementById('pwc-qr').style.display = ""inline"";
                                       //document.g");
            WriteLiteral(@"etElementById('subject').innerHTML = ""Welcome "" + respMsg.fullname +"" from "" + respMsg.company + "", to the Gartner Hotel. Please make sure to use this digital credential as the key for your room, 255F. On file we have "" + respMsg.email + "" as your primary email address, if this isn't correct don't hesitate to speak to our receptionist."";
