#pragma checksum "/home/azureusercoffeeuniversity/AzureSampleTest/active-directory-verifiable-credentials-dotnet/1-asp-net-core-api-idtokenhint/Pages/Verifier.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e13906f10c933f0c62dc5ae12cbc3b131f730495"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e13906f10c933f0c62dc5ae12cbc3b131f730495", @"/Pages/Verifier.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 3 "/home/azureusercoffeeuniversity/AzureSampleTest/active-directory-verifiable-credentials-dotnet/1-asp-net-core-api-idtokenhint/Pages/Verifier.cshtml"
...
#nullable disable
            ...
            <button type=""button"" id=""sign-in"" class=""button"">VERIFY KEY</button>
            ...
            <div id=""message-wrapper"" class=""margin-bottom-75 margin-top-75"" style=""display: none"">
               <i class=""fas fa-user-c");
            WriteLiteral(@"heck green icon-text-large margin-bottom-25""></i>
               <div id=""message""></div>
                <br />
               <div id=""subject""></div>
                <br />
                ...
                signIn.addEventListener('click', () => {
                    ...
                    .then(function(response) {
                        ...
                        .then(function(message) {
                            respPresen");
            WriteLiteral(@"tationReq = JSON.parse(message);
                            if( /Android/i.test(navigator.userAgent) ) {
                                ...
                                document.getElementById('sign-in').style.visi");
                            ...
                            .then(response => {
                                if (response.length > 0) {
                                    ...
                                    if (respMsg.status == 'request_retrieved') {
                                        docum");
            WriteLiteral(@"ent.getElementById('message-wrapper').style.display = ""block"";
                                    ...
                                    if (respMsg.status == 'presentation_verified') {
                                        ...
                                        document.getElementById('subject').innerHTML = ""Welcome "" + respMsg.fullname +"" from "" + respMsg.company + "", to the Gartner Hotel. Please make sure to use this digital credential as the key for your room, 255F. On file ");
            WriteLiteral(@"we have "" + respMsg.email + "" as your primary email address, if this isn't correct don't hesitate to speak to our receptionist."";
