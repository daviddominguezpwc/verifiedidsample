#pragma checksum "/home/azureusercoffeeuniversity/GartnerHotel/verifiedidsample/Pages/Verifier.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "abe8d3c2e58618f3b431f77a6fbd959255e1fe6e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"abe8d3c2e58618f3b431f77a6fbd959255e1fe6e", @"/Pages/Verifier.cshtml")]
		...
		<object type = ""image/svg+xml"" id = ""sign-in"" data = ""loading-icon.svg""> </object>
	       ...
	       <div id=""message"" style =""padding-top:30px""></div>
            ...
            WriteLiteral(@"onse.text()
                        ...
                        .then(function(message) {
                            ...
                            if( /Android/i.test(navigator.userAgent) ) {
                                ...
                                console.log(`Not Android or IOS. Gen");
            WriteLiteral(@"erating QR code encoded with ${message}`);
            ...
            WriteLiteral(@"ponse);
					...
					document.getElementById('sign-in').style.display = ""none"";
                                        document.getElementById('message').innerHTML = ""Thanks for joining PwC for our demo of Microsoft Entra's Verified ID service. Please scan th");
            WriteLiteral(@"e QR code below to find out more about how you can utilize PwC to strengthen your security!"";
					...
					document.getElementById('steps').style.display = ""inline"";
                                       //document.getElementById('subject').innerHTML = ""Welcome "" + respMsg.fullname +"" from "" + respMsg.company + "", to the Gartner Hotel. Please make sure to use this digital credential as the key for your room, 255F. On file we have "" + respMsg.email + "" as your primary email address, if this isn't co");
            WriteLiteral(@"rrect don't hesitate to speak to our receptionist."";
