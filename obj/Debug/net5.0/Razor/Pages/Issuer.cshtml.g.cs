#pragma checksum "/home/azureusercoffeeuniversity/AzureSampleTest/active-directory-verifiable-credentials-dotnet/1-asp-net-core-api-idtokenhint/Pages/Issuer.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1ed65cf59f0ed4c7469383fadfd50bb6bbae311c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1ed65cf59f0ed4c7469383fadfd50bb6bbae311c", @"/Pages/Issuer.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 3 "/home/azureusercoffeeuniversity/AzureSampleTest/active-directory-verifiable-credentials-dotnet/1-asp-net-core-api-idtokenhint/Pages/Issuer.cshtml"
...
#nullable disable
            ...
            <div id=""message-wrapper"" class=""margin-bottom-75 margin-top-75"" style=");
         ...
         ");
            WriteLiteral(@"       console.log(`Android device! Using deep link (${respIssuanceReq.url}).`);
                ...
                if (respIssuanceReq.pin) {
                    ...
                    document.getEleme");
            WriteLiteral(@"ntById('pinCodeText').style.display = ""block"";
                }
                        ...
                        .then(response => {
                            if (response.length > 0) {
                                ...
                                if (respMsg.status == 'request_retrieved') {
                                    ...
                                    document.getElementById('qrcode').style.displ");
            WriteLiteral(@"ay = ""none"";
                                ...
                                if (respMsg.status == 'issuance_error') {
                                    document.getElementById('pinCodeText').style.display = ""none"";
                                    document.getElementById('message').innerHTML = ""Issuance error occured, did you enter the wr");
            WriteLiteral(@"ong pincode? Please refresh the page and try again."";
