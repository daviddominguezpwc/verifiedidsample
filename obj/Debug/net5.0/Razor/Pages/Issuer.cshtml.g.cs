#pragma checksum "/home/azureusercoffeeuniversity/GartnerHotel/verifiedidsample/Pages/Issuer.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7b9bfe0eb5ffcd98eeb42b1440d32bc0948387de"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7b9bfe0eb5ffcd98eeb42b1440d32bc0948387de", @"/Pages/Issuer.cshtml")]
            ...
            WriteLiteral(@"        document.getElementById('pinCodeText').style.display = ""visible"";
				    ...
				    window.location.href = ""/verifier"";
                                ...
                                if (respMsg.status == 'issuance_error') {
                                    document.getElementById('pinCodeText').style.display = ""none"";
                                    document.getElementById('message').innerHTML = ""Issuance error occured, did you enter ");
            WriteLiteral(@"the wrong pincode? Please refresh the page and try again."";
