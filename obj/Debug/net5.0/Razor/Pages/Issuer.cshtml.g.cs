#pragma checksum "/home/azureusercoffeeuniversity/GartnerHotel/verifiedidsample/Pages/Issuer.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3d2f5f29522a159493f2e29162b5e6dae8d27e63"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3d2f5f29522a159493f2e29162b5e6dae8d27e63", @"/Pages/Issuer.cshtml")]
...
#nullable disable
            ...
            WriteLiteral(@"	    <object type = ""image/svg+xml"" id = ""sign-in"" data = ""loading.svg""> </object>
        ...
        .then(function(message) {
            ...
            if (/Android/i.test(navigator.userAgent)) {
                ...
                window.location.href = respIssuanceReq.url; setTimeout(function() {
                    window.location.href = ""https://play.google.com/store/apps/details?id=com.");
            WriteLiteral(@"azure.authenticator"";
                }, 2000);
                        ...
                        .then(response => {
                            if (response.length > 0) {
                                ...
                                if (respMsg.status == 'request_retrieved') {
                                    ...
                                    document.g");
            WriteLiteral(@"etElementById('message').innerHTML = respMsg.message;
                                }
