DISCLAIMER: This implementation is utilizing the majority of Microsoft's sample code. They have the rights to their code and we have no intention of taking this code as our own. This repository is only meant to be up for a temporary period of time, and will be taken down after it isn't needed anymore. 
